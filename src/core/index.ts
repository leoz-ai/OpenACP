...
export { log, initLogger, createChildLogger, createSessionLogger, shutdownLogger, cleanupOldSessionLogs, setLogLevel, type Logger } from './log.js'
...
export type { STTProvider, TTSProvider, STTOptions, STTResult, TTSOptions, TTSResult, SpeechServiceConfig, SpeechProviderConfig } from './speech/index.js'
